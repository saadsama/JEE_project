            ...
            <div class="card-header">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="?filter=emise">Emises</a></li>
                        <li><a class="dropdown-item" href="?filter=payee">Payees</a></li>
                        <li><a class="dropdown-item" href="?filter=annulee">Annulees</a></li>
                    </ul>
                </div>
            </div>
			            ...
			            <tr>
			                ...
			                <td>
			                    <a href="?action=voirFacture&id=${facture.idFacture}"
			                        class="btn btn-primary btn-sm " style=" background-color:orange ; border: none
			                        ">
